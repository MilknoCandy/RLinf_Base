...
class EnvWorker(Worker):
    def __init__(self, cfg: DictConfig):
        ...
        self.enable_a2_stm = bool(
            OmegaConf.select(self.cfg, "algorithm.a2_stm.enable", default=False)
        )
    ...
    @staticmethod
    def _extract_a2_stm_success(env_batch: dict[str, Any]) -> torch.Tensor | None:
